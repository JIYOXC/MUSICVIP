...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002133838077"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/musictalk22")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/FullMusicking")
