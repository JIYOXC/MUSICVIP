...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002060766901"))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002060766901"))
...
AUTO_GCAST_MSG = getenv("AUTO_GCAST_MSG", "True")
...
VIDEO_STREAM_LIMIT = int(getenv("VIDEO_STREAM_LIMIT", "25"))
